...
@RemoteServiceRelativePath("NoticeService")
public interface NoticeService extends RemoteService {
	/**
	 * Utility class for simplifying access to the instance of async service.
	 */
	public static class Util {
		private static NoticeServiceAsync instance;
		public static NoticeServiceAsync getInstance(){
			if (instance == null) {
				instance = GWT.create(NoticeService.class);
			}
			return instance;
		}
	}
